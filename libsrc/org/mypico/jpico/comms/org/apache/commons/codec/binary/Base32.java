...
package org.mypico.jpico.comms.org.apache.commons.codec.binary;
 ...
 * 
 * @since 1.5
 * @version $Id: Base32.java 1435550 2013-01-19 14:09:52Z tn $
 */
public class Base32 extends BaseNCodec {
     ...
     * "Base32 Alphabet" (as specified in Table 3 of RFC 2045) into their 5-bit positive integer
     ...
     * "Base32 Alphabet" equivalents as specified in Table 3 of RFC 2045.
     */
    ...
    /**
     * This array is a lookup table that translates Unicode characters drawn from the
     * "Base32 |Hex Alphabet" (as specified in Table 3 of RFC 2045) into their 5-bit positive
                ...
                if (b >= 0 && b < this.decodeTable.length) {
                    ...
                    if (result >= 0) {
                        ...
                        context.lbitWorkArea =
                                (context.lbitWorkArea << BITS_PER_ENCODED_BYTE) + result;
                        if (context.modulus == 0) { // we can output the 5 bytes
                            buffer[context.pos++] =
                                    (byte) ((context.lbitWorkArea >> 32) & MASK_8BITS);
                            buffer[context.pos++] =
                                    (byte) ((context.lbitWorkArea >> 24) & MASK_8BITS);
                            buffer[context.pos++] =
                                    (byte) ((context.lbitWorkArea >> 16) & MASK_8BITS);
                            buffer[context.pos++] =
                                    (byte) ((context.lbitWorkArea >> 8) & MASK_8BITS);
        ...
        if (inAvail < 0) {
            ...
            switch (context.modulus) { // % 5
                ...
                case 2: // 2 octets = 16 bits to use
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 11) & MASK_5BITS]; // 16-1*5
                                                                                          // = 11
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 6) & MASK_5BITS]; // 16-2*5 =
                                                                                         // 6
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 1) & MASK_5BITS]; // 16-3*5 =
                                                                                         // 1
                    buffer[context.pos++] =
                ...
                case 3: // 3 octets = 24 bits to use
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 19) & MASK_5BITS]; // 24-1*5
                                                                                          // = 19
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 14) & MASK_5BITS]; // 24-2*5
                                                                                          // = 14
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 9) & MASK_5BITS]; // 24-3*5 =
                                                                                         // 9
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 4) & MASK_5BITS]; // 24-4*5 =
                                                                                         // 4
                    buffer[context.pos++] =
                ...
                case 4: // 4 octets = 32 bits to use
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 27) & MASK_5BITS]; // 32-1*5
                                                                                          // = 27
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 22) & MASK_5BITS]; // 32-2*5
                                                                                          // = 22
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 17) & MASK_5BITS]; // 32-3*5
                                                                                          // = 17
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 12) & MASK_5BITS]; // 32-4*5
                                                                                          // = 12
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 7) & MASK_5BITS]; // 32-5*5 =
                                                                                         // 7
                    buffer[context.pos++] =
                            encodeTable[(int) (context.lbitWorkArea >> 2) & MASK_5BITS]; // 32-6*5 =
                                                                                         // 2
                    buffer[context.pos++] =
